...
let defaultBasePath = 'https://repo.withertech.com/scraper/api';
...
export class ScrapeApi {
     ...
     */
    public async scrape (filename: string, md5: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ImagesResult;  }> {
        ...
        if (filename === null || filename === undefined) {
            throw new Error('Required parameter filename was null or undefined when calling scrape.');
        }

        // verify required parameter 'md5' is not null or undefined
        if (md5 === null || md5 === undefined) {
            throw new Error('Required parameter md5 was null or undefined when calling scrape.');
        }
        ...
        if (md5 !== undefined) {
            localVarQueryParameters['md5'] = ObjectSerializer.serialize(md5, "string");
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: ImagesResult;  }>((resolve, reject) => {
