...
qint32 OAIErrorResult::getCode() const {
    return code;
}
void OAIErrorResult::setCode(const qint32 &code) {
    this->code = code;
    this->m_code_isSet = true;
}

bool OAIErrorResult::is_code_Set() const{
    return m_code_isSet;
}

bool OAIErrorResult::is_code_Valid() const{
